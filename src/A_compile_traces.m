...
FolderPath = 'C:\Users\seanm\Desktop\garcia_lab_stuff\elong_auto_corr_analysis\dat\1500b_7dT_set2\';
% FolderPath = 'D:/Data/Nick/LivemRNA/LivemRNAFISH/Dropbox (Garcia Lab)/mHMM/weka/';
project = '1500b_7dT_set2'; %Project Identifier
%%% folders
...
for i = 1:length(cp_filenames) % Loop through filenames    
    ...
    for j = 1:size(traces_clean,2)        
        ...
        trace_struct(j_pass).schnitz = schnitz;
